...
public sealed partial class BiomorphConstructionComponent : Component
{
...
public sealed partial class BiomorphConstructionChooseActionEvent : InstantActionEvent;
public sealed partial class BiomorphConstructionSecreteActionEvent : WorldTargetActionEvent;

[Serializable, NetSerializable]
public sealed class BiomorphConstructionChooseMessage : BoundUserInterfaceMessage
{
    public BiomorphConstructionChooseMessage(EntProtoId structure) => Structure = structure;
    public EntProtoId Structure { get; }
}

[Serializable, NetSerializable]
public sealed class BiomorphConstructionBuiState : BoundUserInterfaceState
{
    public BiomorphConstructionBuiState(List<string> options, string? selected)
    {
        Options = options;
        Selected = selected;
    }
...
[Serializable, NetSerializable]
public enum BiomorphConstructionUiKey : byte
{
    Key
}

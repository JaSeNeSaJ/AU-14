...
public sealed partial class GhostRoleEntryButtons : BoxContainer
{
    ...
    public GhostRoleEntryButtons(GhostRoleInfo ghostRoleInfo)
    {
        ...
        var buttonFont = _resourceCache.GetFont("/Fonts/NotoSansDisplay/NotoSansDisplay-Regular.ttf", 12);
        RequestButton.Label.FontOverride = buttonFont;
        FollowButton.Label.FontOverride = buttonFont;

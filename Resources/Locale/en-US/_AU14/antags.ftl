...
roles-antag-synth-objective = SURVIVE


fugitive-role-greeting = You're a long time infamous criminal hiding out in the colony outskirts, you think the feds are on to you.
roles-antag-fugitive-name = Fugitive
roles-antag-fugitive-objective = Avoid Capture


dealer-role-greeting = You're a dealer jesse, sell your product.
roles-antag-dealer-name = Dealer

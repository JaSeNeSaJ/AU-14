...
public sealed partial class XenoHeadbiteSystem : EntitySystem
{
    ...
    private void OnXenoHeadbiteDoAfter(Entity<XenoHeadbiteComponent> xeno, ref XenoHeadbiteDoAfterEvent args)
    {
        ...
        var change = _damage.TryChangeDamage(target, xeno.Comp.Damage, origin: xeno, tool: xeno); // TODO target head

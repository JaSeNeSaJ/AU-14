...
public sealed partial class CMUMedicalCCVars : CVars
{
    ...
    public static readonly CVarDef<float> BoneProjectileHeadChance =
        CVarDef.Create("cmu.medical.bone.projectile_head_chance", 0.13f, CVar.REPLICATED | CVar.SERVER);

    public static readonly CVarDef<float> BoneProjectileTorsoChance =
        CVarDef.Create("cmu.medical.bone.projectile_torso_chance", 0.06f, CVar.REPLICATED | CVar.SERVER);

    public static readonly CVarDef<float> BoneProjectileArmChance =
        CVarDef.Create("cmu.medical.bone.projectile_arm_chance", 0.12f, CVar.REPLICATED | CVar.SERVER);

    public static readonly CVarDef<float> BoneProjectileLegChance =
        CVarDef.Create("cmu.medical.bone.projectile_leg_chance", 0.12f, CVar.REPLICATED | CVar.SERVER);

    public static readonly CVarDef<float> BoneProjectileOtherChance =
        CVarDef.Create("cmu.medical.bone.projectile_other_chance", 0.07f, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<float> TraumaBallisticHeadOrganChance =
        CVarDef.Create("cmu.medical.trauma.ballistic_head_organ_chance", 0.016f, CVar.REPLICATED | CVar.SERVER);

    public static readonly CVarDef<float> TraumaBallisticTorsoOrganChance =
        CVarDef.Create("cmu.medical.trauma.ballistic_torso_organ_chance", 0.05f, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<float> TraumaPierceBoneChance =
        CVarDef.Create("cmu.medical.trauma.pierce_bone_chance", 0.04f, CVar.REPLICATED | CVar.SERVER);

    public static readonly CVarDef<float> TraumaPierceOrganChance =
        CVarDef.Create("cmu.medical.trauma.pierce_organ_chance", 0.035f, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<float> TraumaSlashBoneChance =
        CVarDef.Create("cmu.medical.trauma.slash_bone_chance", 0.02f, CVar.REPLICATED | CVar.SERVER);

    public static readonly CVarDef<float> TraumaSlashOrganChance =
        CVarDef.Create("cmu.medical.trauma.slash_organ_chance", 0.02f, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<float> TraumaBluntBoneChance =
        CVarDef.Create("cmu.medical.trauma.blunt_bone_chance", 0.10f, CVar.REPLICATED | CVar.SERVER);

    public static readonly CVarDef<float> TraumaBluntOrganChance =
        CVarDef.Create("cmu.medical.trauma.blunt_organ_chance", 0.01f, CVar.REPLICATED | CVar.SERVER);
    ...
    /// <summary>
    ///     Fraction of the ledger region damage capacity a freshly-reattached
    ///     limb starts at.
    /// </summary>
    ...
    /// <summary>
    ///     Burn damage threshold where the human ledger marks a burn as
    ///     necrotic/eschar-grade.
    /// </summary>

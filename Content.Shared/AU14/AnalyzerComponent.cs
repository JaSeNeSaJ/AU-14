...
public sealed partial class AnalyzerComponent : Component
{
    ...
    /// <summary>
    /// Configurable submittable-for-points table. When non-empty, only these entities convert into
    /// points, each at its own ratio, instead of the built-in dollars behavior. Set at deploy time from
    /// the active INSFOR faction. Empty keeps the classic "dollars at the built-in rate" behavior.
    /// </summary>
    [DataField]
...
/// <summary>
/// One configured conversion: <see cref="AmountPerPoint"/> of <see cref="Entity"/> earns one point.
/// </summary>
[DataDefinition]
